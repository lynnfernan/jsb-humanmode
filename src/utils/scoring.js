...
function assignProfile(accuracy, bias, typeScores, missesNeutral) {
  if (accuracy >= 80) {
    return {
      ...
      insight: `Many people lock onto one or two faces and assume they represent the group. You don't. You track the spread — the overall vibe and sense of how much of the group is energized, struggling, cohesive or having very different reactions.\n\nThe science conducted by J. Sanchez-Burks and others shows this is the rarest and most consequential leadership skill. In teams, it's the difference between seeing a problem coming and being surprised by it.\n\nYour next edge: the moments that will test this skill aren't the obvious ones. They're the meetings where everything looks fine on the surface. Keep scanning even when the room seems calm.`,
